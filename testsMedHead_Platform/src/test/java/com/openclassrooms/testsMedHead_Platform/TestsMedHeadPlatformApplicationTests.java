...
class TestsMedHeadPlatformApplicationTests {
	...
	public void testIfSpecialityGroupExistsTrue() {
		...
		try {
			...
			System.out.println("\n**********************************************************************\n");
			System.out.println("    Il y a un problème dans \n" + "	dans testIfSpecialityGroupExistsTrue! : " + e + "ligne 296 ");
			System.out.println("\n**********************************************************************");
			e.printStackTrace();
		}
	}
	...
	public void testIfSpecialityGroupExistsFalse() {
		...
		try {
			...
			System.out.println("\n**********************************************************************\n");
			System.out.println("    Il y a un problème dans \n" + "	dans testIfSpecialityGroupExistsFalse! : " + e + "ligne 341 ");
			System.out.println("\n**********************************************************************");
			e.printStackTrace();
		}
	}
	...
	public void testIfHopitalCenterExistsFalse() {
		...
		try {
			...
			System.out.println("\n**********************************************************************\n");
			System.out.println("    Il y a un problème dans \n" + "	dans testIfHopitalCenterExistsFalse! : " + e + "ligne 423 ");
			System.out.println("\n**********************************************************************");
			e.printStackTrace();
		}
	}
	...
	public void testWhatSpecialitiesHaveThisHospital() {
		...
		try {
			...
			System.out.println("\n**********************************************************************\n");
			System.out.println("    Il y a un problème dans \n" + "	dans testWhatSpecialitiesHaveThisHospital!: " + e + "ligne 515 ");
			System.out.println("\n**********************************************************************");
			e.printStackTrace();
		}
	}
