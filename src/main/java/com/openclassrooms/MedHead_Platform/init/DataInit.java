...
public class DataInit implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		if (count == 0) {
			...
			Hospital h2 = new Hospital("Anesthesie", "Soins intensifs", "Mulhouse", 150, 75, 47.74, 7.33, 0);
			Hospital h3 = new Hospital("Groupe dentaire", "Orthodontie", "Brest", 10, 5, 48.39, -4.48, 0);
			Hospital h4 = new Hospital("Groupe dentaire", "Orthodontie", "Cherbourg", 10, 10, 49.63, -1.62, 0);
			Hospital h5 = new Hospital("Médecine d'urgence", "Médecine d'urgence", "Montpellier", 250, 115, 43.63, 3.86, 0);
			Hospital h6 = new Hospital("Groupe de médecine générale", "Allergie", "Toulouse", 70, 10, 43.61, 1.39, 0);	
			Hospital h7 = new Hospital("Groupe de médecine générale", "Cardiologie", "Strasbourg", 200, 199, 48.58, 7.74, 0);
			Hospital h8 = new Hospital("Groupe de médecine générale", "Cardiologie", "Nantes", 150, 150, 47.23, -1.58, 0);
			Hospital h9 = new Hospital("Groupe de médecine générale", "Pédiatrie", "Orléans", 200, 180, 47.90, 1.89, 0);
			Hospital h10 = new Hospital("Groupe de médecine générale", "Cardiologie", "Orléans", 200, 180, 47.90, 1.89, 0);
			Hospital h11 = new Hospital("Groupe pathologie", "Cardiologie pédiatrique", "Lille", 80, 40, 50.62, 3.08, 0);
			Hospital h12 = new Hospital("Groupe pathologie", "Virologie", "Macon", 250, 115, 46.31, 4.84, 0);
			Hospital h13 = new Hospital("Groupe de psychiatrie", "Psychiatrie légale", "Marseille", 30, 7, 43.30, 5.38, 0);
			Hospital h14 = new Hospital("Groupe de psychiatrie", "Psychiatrie générale", "Orange", 30, 7, 44.13, 4.8, 0);
			Hospital h15 = new Hospital("Groupe radiologie", "Médecine nucléaire", "Paris", 500, 450, 48.84, 2.41, 0);
			Hospital h16 = new Hospital("Groupe chirurgical", "Neurochirurgie", "Lyon", 80, 80, 45.77, 4.85, 0);
			Hospital h17 = new Hospital("Groupe chirurgical", "Neurochirurgie", "Saint Etienne", 80, 55, 45.41, 4.39, 0);
			Hospital h18 = new Hospital("Groupe chirurgical", "Chirurgie plastique", "Colmard", 250, 115, 48.08, 7.34, 0);
